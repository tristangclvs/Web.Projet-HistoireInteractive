        ...
        <div class="container">
            <div class="col-10">
                <a class="navbar-brand text-uppercase fw-bold" href="index.php" id="baliseb">
                    <img src="images/book.png" alt="book_logo" class="me-2" style="height: 48px; padding-bottom: 1%;"> <!-- icon by Icongeek26 -->
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark " aria-labelledby="dropdownMenuButton1">
                        ...
                        if($_SESSION['nav']=='Se connecter'){
                            echo '<li class="nav-item"><a class="nav-link dropdown-item text-white" href="login.php">' .$_SESSION['nav'].'</a></li>';
                        }
                        else{
                            echo '<li class="nav-item"><a class="nav-link  dropdown-item  text-white" href="deconnection.php">Se déconnecter</a></li><li class="nav-item"><a class="nav-link text-black" href="../movie_add.php">Ajouter un Film</a></li>';
                        }
                        ?>
